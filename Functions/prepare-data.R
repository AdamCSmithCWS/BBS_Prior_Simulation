...
#' @param return_dataframe logical, if FALSE (default) returns a list for use in a bayesian sampling, if TRUE returns a dataframe of all observations with additional information that may be useful to a analyst intending a custom analysis
...
prepare_data <- function(return_dataframe = FALSE,
                         strat_data = NULL,
                         species_to_run = NULL,
                         model = NULL,
                         heavy_tailed = FALSE,
